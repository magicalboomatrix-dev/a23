      ...
      <div className="bg-white border overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              <th className="text-left px-2 py-2 font-medium text-gray-600">ID</th>
              ...
              <th className="text-right px-2 py-2 font-medium text-gray-600">Bal</th>
              <th className="text-right px-2 py-2 font-medium text-gray-600">Bonus</th>
              <th className="text-left px-2 py-2 font-medium text-gray-600">Moderator</th>
              <th className="text-left px-2 py-2 font-medium text-gray-600">Ref</th>
            ...
            {users.map((u) => (
              <tr key={u.id} className="hover:bg-gray-50">
                ...
                <td className="px-2 py-2 text-center">
                  <span className={`px-1.5 py-0.5 text-xs font-medium ${u.is_blocked ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                ...
                <td className="px-2 py-2 text-center">
                  <div className="flex flex-col items-center gap-1">
                    <Link
                      to={`/users/${u.id}`}
                      className="px-2 py-0.5 text-xs font-medium bg-blue-600 text-white hover:bg-blue-700"
                    >
                      Details
                    </Link>
                    <select
